...
export default function Sidebar() {
  ...
  return (
    <aside className={`${isOpen ? 'w-64' : 'w-0'} bg-white shadow-[4px_0_24px_rgba(0,0,0,0.03)] flex-col h-full shrink-0 hidden md:flex z-20 border-r border-gray-100 transition-all duration-300 overflow-hidden`}>
